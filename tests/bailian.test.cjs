...
const valid = { scene: 'parents', duration: 240, budget: '300', walking: 'low', preferredPlaceIds: ['nitori'], excludedPlaceIds: ['daka-coffee', 'luckin-coffee', 'golden-coffee'], indoorOnly: true };
